...
def transaction_success(money_recieved, drink_cost):
    "retunr True when money is acepted and False when not enough"
...
def make_cofffee(drink_name, order_ingredients):
    """restar los ingredientes a los recursos"""
    for item in order_ingredients:
